...
ADDRESS = "USB0"
CHANNEL = 1
OUTPUT_CSV_DEFAULT = r"biologic\lsv_results.csv"
...
def run_lsv(output_csv: str) -> None:
    ...
    try:
        ...
        # Configure a single forward scan using the CV technique.
        ...
        cv_params.extend(
            [
                ...
                make_ecc_parm(api, CV_PARMS["n_cycles"], 0),
        ...
        print(f"LSV started on channel {CHANNEL} using {tech_file}")
        ...
        print(f"LSV finished. Saved {count} points to {output_csv}")
    finally:
        api.Disconnect(idn)
        print("Disconnected.")
